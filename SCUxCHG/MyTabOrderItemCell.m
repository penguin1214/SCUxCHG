...
@implementation MyTabOrderItemCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    _vPenddingLabel.textColor = kColorGray;
...
- (void)clickGrid1
{
    [self.delegate doGotoOrderListPageWithListStatus:kListStatusPenddingPay];
}

- (void)clickGrid2
{
    [self.delegate doGotoOrderListPageWithListStatus:kListStatusDelivering];
}

- (void)clickGrid3
{
    [self.delegate doGotoOrderListPageWithListStatus:kListStatusFinished];
}
